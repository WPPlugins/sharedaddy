...
class Share_Digg extends Sharing_Advanced_Source {
	...
	public function get_display( $post ) {
		if ( $this->smart ) {
			...
			return $this->get_link( get_permalink( $post->ID ), _x( 'Digg', 'share to', 'sharedaddy' ), __( 'Click to Digg this post' ), 'share=digg' );
	}	
